...
| Prop           | 类型                   | 必需 | 默认值                                   | 说明                       |
| -------------- | ---------------------- | :--: | ---------------------------------------- | -------------------------- |
| `region`       | `EditorControlRegion`  |  否  | `{ layout: 'toolbar', density: 'calm' }` | 主题声明的编辑控件区域配置 |
...
| `region`      | `StatusBarRegion` |  否  | `{ layout: 'full', density: 'calm' }` | 主题声明的状态栏区域配置            |
...
| `region`        | `TopBarRegion`  |  否  | `{ variant: 'balanced', layout: 'classic' }` | 主题声明的顶栏区域配置 |
...
| `activePath` | `string`                                                     |  是  | —                                          | 当前活跃笔记路径       |
| `region`     | `LeftWingRegion`                                             |  否  | `{ mode: 'default', layout: 'bookmarks' }` | 主题声明的左翼区域配置 |
...
| `region`          | `RightWingRegion` |  否  | `{ mode: 'balanced', policy: 'outline', sections: ['outline','backlinks','tags'], defaultOpenSections: ['outline','tags'] }` | 主题声明的右翼区域配置 |
