...
| **样式 Token 约束** | 禁止使用 `design-system.md` 未定义的色值/字号/间距/圆角         | stylelint `color-no-hex` + `function-disallowed-list` |
...
| Stylelint       | `npx stylelint "src/**/*.{vue,css}"` | 零错误（强制 Design Token 检查） |
